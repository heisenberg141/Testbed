...
1. `generate_network.py`: This file is used to geenerate the json file for the road network from sumo's opendrive format.  
2. `generate_json_network.py`: This file is used to convert a commonroad scenario to json file.  
3. `convert_s2c.py`: This file is used to convert a road network from sumo's opendrive format to commonroad scenario.   
